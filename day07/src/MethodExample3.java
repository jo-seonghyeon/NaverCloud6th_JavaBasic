...
public class MethodExample3 {
	 ...
	 * 4. 전달 할 반환 값의 자료형을 반환 유형이라고 부릅니다.
	 * 5. 반환값이 있는 메서드는 호출문 위치에 하나의 값이 전달되기 때문에 매직넘버 대신 사용 할 수 있습니다.
	 * 6. 반환 값이 없는 메서드는 void를 기입합니다. 이 때는 return 구문을 쓰지 않아도 됩니다.
	 * 7. 모든 메서드는 return을 만나는 순간 즉시 종료 됩니다.
	...
	public static void callMyName(String name) {
		// 문자열도 배열이므로 .length()로 문자 개수를 셀 수 있습니다.
		if(name.length() < 2) {
	...
	public static void main(String[] args) {
		int result1 = add(3, 5);
		System.out.println(result1); // System.out.println(add(3, 5)); 와 결과 동일 
		...
		callMyName("김자바"); // 반환값이 void이며 return 실행 안됨
		callMyName("채"); // 반환값이 void이며 return 실행됨
