...
public class ArrayExample {
	...
	public static void main(String[] args) {
		...
		// 배결의 생성 - heap에 실제 데이터가 저장될 공간을 생성
		...
		// 사람은 순서를 1부터 세지만, 프로그래밍에서는 0부터 셉니다.
		score[0] = 12;
		score[1] = 67;
		score[4] = 55;
		...
		/*
		 * 배열 내부에 저장된 값들을 한 눈에 문자열 형태로 확인하기 위해서는
		 * Arrays.toSrting(배열변수); 를 사용합니다
		 */
		...
		int[] iArr = new int[7];	// 위에서는 선언과 생성을 두 줄에 걸쳐 진행하였음
