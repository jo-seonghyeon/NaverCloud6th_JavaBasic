 ...
 * 2. 메서드의 선언은 메서드 내부에서도 할 수 없습니다. 클래스 내부이면서 다른 메서드 외부에 작성해야 합니다.
 * 3. 메서드 내부에서는 다른 메서드의 호출만 가능합니다.
 * 4. 호출하는 과정중 다른 메서드 내부 지역으로 이동해서 해당 코드를 실행하고
 * 	  타 메서드 호출이 끝나면 원래 호출했던 위치로 복귀합니다.
 */

public class MethodExample1 {
	
	public static void sayHello() {
		System.out.println("안녕하세요! sayHello 메서드를 호출 하셨네요!");
