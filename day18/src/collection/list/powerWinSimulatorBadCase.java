...
public class powerWinSimulatorBadCase {
	...
	public static void main(String[] args) {
		...
		while(!(powerTryNumbers.equals(powerWinNumber) && powerWinNumber.equals(powerTryNumber))) {
			count++;
...
//			System.out.println(powerWinNumber);
//			System.out.println("---------------");
		}
		System.err.println("당신은 " + count + "장의 파워볼을 사고서야 당첨되었습니다.");
